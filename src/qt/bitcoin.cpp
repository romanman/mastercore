...
int main(int argc, char *argv[])
{
    ...
    strWarningText += "Omni Core should be considered an alpha-level product, and you use it at your own risk. Neither the Mastercoin Foundation nor the Omni Core developers assumes any responsibility for funds misplaced, mishandled, lost, or misallocated.\n\n";
